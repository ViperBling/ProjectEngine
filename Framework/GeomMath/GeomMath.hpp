...
#undef min
    ...
    struct Vector2Type
    {
        union {
            ...
            struct { T r, g; };
            struct { T u, v; };
            swizzle<ProjectEngine::Vector2Type, T, 0, 1> xy;
            swizzle<ProjectEngine::Vector2Type, T, 1, 0> yx;
        };
    ...
    struct Vector3Type
    {
        union {
            ...
            swizzle<ProjectEngine::Vector2Type, T, 0, 1> xy;
            swizzle<ProjectEngine::Vector2Type, T, 1, 0> yx;
            swizzle<ProjectEngine::Vector2Type, T, 0, 2> xz;
            swizzle<ProjectEngine::Vector2Type, T, 2, 0> zx;
            swizzle<ProjectEngine::Vector2Type, T, 1, 2> yz;
            swizzle<ProjectEngine::Vector2Type, T, 2, 1> zy;
            swizzle<ProjectEngine::Vector3Type, T, 0, 1, 2> xyz;
            swizzle<ProjectEngine::Vector3Type, T, 1, 0, 2> yxz;
            swizzle<ProjectEngine::Vector3Type, T, 0, 2, 1> xzy;
            swizzle<ProjectEngine::Vector3Type, T, 2, 0, 1> zxy;
            swizzle<ProjectEngine::Vector3Type, T, 1, 2, 0> yzx;
            swizzle<ProjectEngine::Vector3Type, T, 2, 1, 0> zyx;
        };
    ...
    struct Vector4Type
    {
        union {
            ...
            swizzle<ProjectEngine::Vector3Type, T, 2, 0, 1> zxy;
            swizzle<ProjectEngine::Vector3Type, T, 2, 1, 0> zyx;
            swizzle<ProjectEngine::Vector4Type, T, 2, 1, 0, 3> bgra;
        };
