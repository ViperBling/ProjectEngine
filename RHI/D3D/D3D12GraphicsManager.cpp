...
HRESULT ProjectEngine::D3D12GraphicsManager::CreateDescriptorHeaps()
{
    HRESULT hr;
...
HRESULT ProjectEngine::D3D12GraphicsManager::CreateVertexBuffer(const Buffer& buffer)
{
    HRESULT hr;
...
HRESULT ProjectEngine::D3D12GraphicsManager::CreateIndexBuffer(const Buffer& buffer)
{
    HRESULT hr;
...
HRESULT ProjectEngine::D3D12GraphicsManager::CreateTextureBuffer(const Image& image)
{
    HRESULT hr;
...
HRESULT ProjectEngine::D3D12GraphicsManager::CreateSamplerBuffer()
{
...
HRESULT ProjectEngine::D3D12GraphicsManager::CreateConstantBuffer(const Buffer& buffer)
{
    return S_OK;
}


HRESULT ProjectEngine::D3D12GraphicsManager::CreateGraphicsResources()
{
    HRESULT hr;
...
int  ProjectEngine::D3D12GraphicsManager::Initialize()
{
    int result = 0;
...
void ProjectEngine::D3D12GraphicsManager::Tick()
{
}

void ProjectEngine::D3D12GraphicsManager::Finalize()
{
