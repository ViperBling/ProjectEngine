...
const std::shared_ptr<SceneObjectCamera> Scene::GetCamera(const string &key) const {
...
const std::shared_ptr<SceneObjectLight> Scene::GetLight(const string &key) const {
...
const std::shared_ptr<SceneObjectGeometry> Scene::GetGeometry(const string &key) const {
...
const std::shared_ptr<SceneObjectMaterial> Scene::GetMaterial(const string &key) const {
